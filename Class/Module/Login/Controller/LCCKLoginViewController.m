...
- (void)viewDidLoad {
    ...
    if (self.autoLogin && clientId) {
        ...
        !_clientIDHandler ?: _clientIDHandler(clientId,self.abcde.text, self.abcGroupID.text, self.abcGroupName.text) ;
    }
}
...
- (void)autoCompleteTextField:(MLPAutoCompleteTextField *)textField
  didSelectAutoCompleteString:(NSString *)selectedString
    ...
    !_clientIDHandler ?: _clientIDHandler(selectedString,self.abcde.text, self.abcGroupID.text, self.abcGroupName.text);
}
