...
- (NSMutableArray *)chatDetailDataBySingleInfo:(AVIMConversation *)singleInfo {
    ...
    LCCKSettingItem *screen = LCCKCreateSettingItem(@"Mute");
    screen.type = LCCKSettingItemTypeSwitch;
    screen.isSwithOn = singleInfo.muted;
    LCCKSettingGroup *group2 = LCCKCreateSettingGroup(nil, nil, (@[screen]));
    ...
    LCCKSettingGroup *group4 = LCCKCreateSettingGroup(nil, nil, (@[chatBG]));
    ...
    LCCKSettingItem *report = LCCKCreateSettingItem(@"Report");
    LCCKSettingGroup *group6 = LCCKCreateSettingGroup(nil, nil, @[report]);
    
    NSMutableArray *data = [[NSMutableArray alloc] init];
    
    [data addObjectsFromArray:@[group1, group2, group6]];
